        ...
        <div class="row p-2">
          <div class="col-sm-7">
            ...
            <table class="table table-sm table-striped">
              ...
              <tr>
                <td>
                  <div class="pl-2 text-sm">Rincian Biaya : </div>
                </td>
                <td>
...
$(function() {
  ...
  function laporan_lr(aw, ah) {
    let total = $.post(service_url + 's_laporan.php', {
      ...
      total_pengeluaran = parseInt(data.total_biaya) + parseInt(data.jual_kotor.total_hpp)
      ...
      $('#total-biaya-bv').text(formatCurrency(data.total_bv))
