        ...
        <div class="card card-secondary card-outline">
          <form id="f-po" name="f-po" class="form-horizontal f-form" autocomplete="off">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <h5>Nomor <i class="fas fa-hashtag mr-2"></i><span id="text-nomorpo" class="text-danger">
                      <?php echo $po;?></span>
                    <small class="float-right"> , Oleh : <span>
                        <?php echo $username;?></span></small>
                    <small class="float-right">Tanggal Buat :
                      <?php echo $tgl_buat;?></small>
                  </h5>
                </div>
              </div>
              <hr />
                  ...
                  <div class="table-responsive">
                    <table class="table table-sm table-striped table-head-fixed text-nowrap p-1" id="tb-detail-po">
                      <thead class="bg-gray">
                        ...
                        <td style="width:12%;">
                          <div class="text-center">@Harga Beli</div>
                        </td>
                        <td style="width:5%;">
