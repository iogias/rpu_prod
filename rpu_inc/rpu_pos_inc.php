...
<form id="f-inv" name="f-inv" class="form-horizontal" autocomplete="off">
            ...
            <div class="card-body bg-light">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h5>INVOICE Nomor <i class="fas fa-hashtag mr-2"></i><span id="text-nomorinv" class="text-danger"><?php echo $inv;?></span>
                        <small class="float-right"> , Oleh : <span><?php echo $username;?></span></small>
                        <small class="float-right">Tanggal Invoice : <?php echo $tglbuatinv;?></small>
                        </h5>
                    </div>
                </div>
            <hr />
            ...
            <table class="table table-sm table-striped table-head-fixed text-nowrap p-1" id="tb-detail-inv">
                <thead class="bg-lightblue">
                    ...
                    <td style="width:4%;"><div class="text-center">Stok</div></td>
                    <td style="width:12%;"><div class="text-center">@Harga</div></td>
                ...
                <tbody>
                    ...
                    <td>
                        <input value="<?php echo money_simple($prod[$jj]['harga_jual']);?>" type="text" class="form-control-plaintext p-0 m-0 text-right" name="det-td-harga-produk" id="td-hargaproduk-<?php echo $jj;?>" readonly />
                    </td>
                    <td>
