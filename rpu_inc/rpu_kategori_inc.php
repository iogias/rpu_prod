...
<div class="card card-primary card-outline">
  <div class="card-header">
    ...
    <button id="tambah-kategoriproduk" type="btn" class="btn btn-primary btn-tambah" data-toggle="modal" data-target="#modal-kategoriproduk">
...
<div class="table-responsive">
  <table id="tb-kategoriproduk" class="table table-sm table-striped">
  <thead>
  <tr>
    <th>Nama</th>
    <th>Keterangan</th>
...
<div class="modal fade" id="modal-kategoriproduk">
...
<div class="modal-body">
    <form class="form-horizontal" id="f-kategoriproduk" name="f-kategoriproduk" autocomplete="off">
      <div class="card-body">
        <div class="form-group row">
          <label for="nama" class="col-sm-2 col-form-label">Nama*</label>
          <div class="col-sm-8">
            <input type="hidden" class="form-control" id="id-kategoriproduk" name="id-kategoriproduk">
...
<button type="button" class="btn btn-success btn-form" id="btn-kategoriproduk-update">Update</button>
<button type="button" class="btn btn-primary btn-form" id="btn-kategoriproduk-simpan">Simpan</button>
...
<script>
$(function () {
    let param = 'kategoriproduk'
    fetch_kategoriproduk()
    function fetch_kategoriproduk(arg='99'){
    ...
    $('#filter-status').change(function(e){
      ...
      fetch_kategoriproduk(vale)
    })

    $('.btn-tambah').click(function(){
      let idx=$(this).attr('id').replace('tambah-','')
      if(idx=='kategoriproduk'){
        $('#f-'+idx)[0].reset()
